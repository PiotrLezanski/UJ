...
class Dialogs
{
    public static NpcD Dialog1 = new NpcD(
        "Hi, could you help me get to the next town?", new List<HD> {
            new HD("Yeah, with pleasure",
                new NpcD("Thank you! As a reward I'll give you 100 gold", new List<HD> {
                        new HD("I'll notify you when I'm ready", null),
                        new HD("100 gold is not enough!",
                            new NpcD("I am very poor, I do not have more money", new List<HD> {
    ...
    public static NpcD Dialog2 = new NpcD(
        "Oi! Aren't you the faumous dragon slayer #HERONAME#?!", new List<HD> {
